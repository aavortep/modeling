...
if __name__ == '__main__':
    ...
    operators = [Operator(storage_1, TimeDistribution(15, 25)),
                 Operator(storage_1, TimeDistribution(30, 50)),
    ...
    print('Вероятность отказа: ', round((result['lost_count'] / requests_count), 4))
